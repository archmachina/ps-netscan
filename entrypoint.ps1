...
Invoke-CIProfile -Name $Profile -Steps @{
    ...
    build = @{
        Script = {
            ...
            Write-Information "Templating NetScan.psd1"
            Format-TemplateFile -Template source/NetScan.psd1.tpl -Target source/NetScan/NetScan.psd1 -Content @{
            ...
            Install-PSModuleFromManifest -ManifestPath source/NetScan/NetScan.psd1

            # Test the module manifest
            Write-Information "Testing module manifest"
            Test-ModuleManifest source/NetScan/NetScan.psd1

            # Import modules as test
            Write-Information "Importing module"
            Import-Module ./source/NetScan/NetScan.psm1
        }
    }
    ...
    release = @{
        ...
        Script = {
            ...
            Publish-Module -Path ./source/NetScan -NuGetApiKey $Env:NUGET_API_KEY
        }
    }
}
