...
Invoke-BuildStage -Name "Build" -Filters $Stages -Script {
    ...
    Write-Information "Templating Noveris.NetScan.psd1"
    Format-TemplateFile -Template source/Noveris.NetScan.psd1.tpl -Target source/Noveris.NetScan/Noveris.NetScan.psd1 -Content @{
    ...
    Install-PSModuleFromManifest -ManifestPath source/Noveris.NetScan/Noveris.NetScan.psd1

    # Test the module manifest
    Write-Information "Testing module manifest"
    Test-ModuleManifest source/Noveris.NetScan/Noveris.NetScan.psd1

    # Import modules as test
    Write-Information "Importing module"
    Import-Module ./source/Noveris.NetScan/Noveris.NetScan.psm1
}
...
Invoke-BuildStage -Name "Publish" -Filters $Stages -Script {
    ...
    # Publish module
    Publish-Module -Path ./source/Noveris.NetScan -NuGetApiKey $Env:NUGET_API_KEY
}
